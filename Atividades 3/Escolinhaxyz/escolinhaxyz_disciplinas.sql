...
CREATE TABLE `disciplinas` (
  ...
  CONSTRAINT `disciplinas_ibfk_1` FOREIGN KEY (`codcurso`) REFERENCES `curso` (`codcurso`)
...
INSERT INTO `disciplinas` VALUES (1,'Matemática Financeira',3,'Calculos e Estatisticas',1),(2,'Jogos',5,'Jogos digitais',2),(3,'Fotográfias',3,'Fotográfia e iluminação',3);
