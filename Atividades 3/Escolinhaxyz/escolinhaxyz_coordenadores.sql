...
CREATE TABLE `coordenadores` (
  ...
  CONSTRAINT `coordenadores_ibfk_1` FOREIGN KEY (`codcurso`) REFERENCES `curso` (`codcurso`)
...
INSERT INTO `coordenadores` VALUES (1,'Aldaberto','Centro','Caravaggio','SC',232,1500.00,1),(2,'Jorge','Centro','Nova Veneza','SC',232,1500.00,2),(3,'Caue','Centro','Rio mania','SC',232,2000.00,3);
